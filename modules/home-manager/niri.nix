# https://github.com/terlar/nix-config/blob/main/modules/home/services/window-managers/niri.nix
{
  config,
  lib,
  pkgs,
  ...
  config = lib.mkIf cfg.enable {
    ...
    wayland.windowManager.niri = lib.mkMerge [
      (lib.mkIf cfg.xwayland.enable {
        spawnAtStartup = [ "${pkgs.xwayland-satellite}/bin/xwayland-satellite" ];
      })
